...
const Stats = () => {
  return (
    <div className="flex md:justify-between justify-center text-center items-center  bg-gradient-to-r from-[#4F39F6] to-[#9514FA] py-5 md:py-12 md:px-100 text-white md:mb-20 mb-10">
      <div>
