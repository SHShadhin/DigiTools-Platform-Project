      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10 max-w-9/12 mx-auto">
          ...
          <div className="card-body">
            ...
            <div>
              <h2 className="text-4xl font-bold">
                0$<span className="text-2xl font-thin">/month</span>
              </h2>
            </div>
        ...
        <div className="card transition-all duration-300 hover:scale-102 hover:shadow-lg rounded-3xl relative text-white bg-gradient-to-r from-[#4F39F6] to-[#9514FA] shadow-sm">
          <div className="card-body">
            ...
            <div>
              <h2 className="text-4xl font-bold">
                29$<span className="text-2xl font-thin">/month</span>
              </h2>
            </div>
            <ul className="mt-6 flex flex-col gap-2 text-xs">
              <li>
            ...
            <div className="mt-6">
              <button className="btn text-[#9514FA] bg-white w-full rounded-3xl">
                Start Pro Trial
              </button>
            </div>
          </div>
        ...
        <div className="card transition-all duration-300 hover:scale-102 hover:shadow-lg hover:bg-base-200 rounded-3xl bg-gray-100 shadow-sm">
          <div className="card-body">
            ...
            <div>
              <h2 className="text-4xl font-bold">
                99$<span className="text-2xl font-thin">/month</span>
              </h2>
            </div>
            <ul className="mt-6 flex flex-col gap-2 text-xs">
              <li>
