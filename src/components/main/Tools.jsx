...
const Tools = ({ toolsPromise }) => {
  ...
  console.log(tools)
  return (
    <div className='grid md:grid-cols-3 gap-10 max-w-9/12 mx-auto pb-20'>
      {tools.map(tool => (
        <div className="card rounded-3xl bg-white border border-gray-100 shadow-sm">
          <div className="card-body relative">
            <span className="badge badge-sm rounded-3xl badge-warning absolute md:top-4 md:right-5 top-3 right-4">
              {tool.tag}
            </span>
            <div className="mt-7 h-12 w-12 shadow-lg bg-white rounded-full p-3">
            ...
            <div className="mt-4">
              <button className="btn  bg-gradient-to-r from-[#4F39F6] to-[#9514FA] rounded-3xl w-full text-white">
                Buy Now
              </button>
            </div>
          </div>
